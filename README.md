...
**Tracking your reading.** Entries use task-list checkboxes as a "Read?" column: `- [ ]` is unread and `- [x]` is read. Tick a box (edit the file, or click it in GitHub's rendered view) as you finish each item.
